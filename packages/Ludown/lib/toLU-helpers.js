...
const toLUHelpers = {
    ...
    constructMdFileHelper : async function(LUISJSON, QnAJSONFromTSV, QnAAltJSON, luisFile, QnAFile, skip_header) {
        ...
        if(fileContent) {
            ...
            let t = fileContent; 
            fileContent = '> ! Automatically generated by [LUDown CLI](https://github.com/microsoft/botbuilder-tools/tree/master/packages/Ludown), ' + now.toString() + NEWLINE + NEWLINE;
